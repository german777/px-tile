'use strict';(function(){Polymer({is:'px-action-buttons',properties:{/**
     ...
     */detached:function detached(){if(this.$$('#pxDropdown')){this.unlisten(this.$$('#pxDropdown'),'px-dropdown-selection-changed')}},/**
