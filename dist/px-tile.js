...
this._hoverTextColor=window.getComputedStyle(this.$.overlay).color}},/**
     ...
     */_onDataChanged:function _onDataChanged(){this._hasTitleActionBtn=this.title&&this.title.length>0||this._hasPrimaryBtn;this._hasTitleSubtitleActionBtn=this.subtitle&&this.subtitle.length>0||this._hasTitleActionBtn;this._hasData=this._hasActionButtons||this._hasTitleSubtitleActionBtn}/**
