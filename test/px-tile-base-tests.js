...
function runBaseTests() {
  px_tile_1 = document.getElementById('px_tile_1');

  suite('Base Automation Tests for px-tile', function() {

    test('Polymer exists', function() {
      assert.isTrue(Polymer !== null);
    });
    test('px-tile fixture is created', function() {
      assert.isTrue(document.getElementById('px_tile_1') !== null);
    });
